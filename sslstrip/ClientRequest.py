...
#        self.uniqueId      = random.randint(0, 10000)
    ...
    def getPathToLockIcon(self):
        ...
        scriptPath = os.path.join(scriptPath, "/usr/share/subterfuge/lock.ico")
    ...
    def handleHostResolvedSuccess(self, address):
        ...
        path              = self.getPathFromUri()
            ...
            #0sm0s1z
            #This section tracks IP address connections made
        with open(str(os.path.dirname(os.path.abspath(__file__))) + '/clientip', 'w') as file:
